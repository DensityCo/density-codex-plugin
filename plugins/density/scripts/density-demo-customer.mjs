...
import { defaultDemoSourceDir, fileExists, run, storageReport, which } from './density-lib.mjs';
...
const sourceDir = sourceArg ? sourceArg.slice('--source='.length) : defaultDemoSourceDir();
